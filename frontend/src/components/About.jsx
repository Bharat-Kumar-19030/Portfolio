...
const About = () => {
  ...
  return (
    <section id="about" className="relative  overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-teal-500/5 rounded-full blur-[150px]" />
      <div className="absolute -top-4 0 -left-40 w-[500px] h-[500px] bg-teal-500/15 rounded-full blur-[150px] animate-blob animation-delay-2000" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start ">
            ...
            <motion.div variants={itemVariants}>
              <div className="glass-strong rounded-2xl overflow-hidden">
                ...
                <div className="p-6 font-mono text-sm leading-relaxed space-y-3">
                  <p><span className="text-blue-400">const</span> <span className="text-teal-300">aboutMe</span> = {'{'}</p>
            ...
            <motion.div variants={itemVariants} className="space-y-6 px-4 md:px-1">
              <p className="text-gray-300 text-lg leading-relaxed">
                I'm a passionate <span className="text-blue-400 font-semibold"> B.Tech CSE student</span> at 
                Lovely Professional University, recognized in the <span className="text-teal-400 font-semibold">Dean's List 
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                <span className="text-blue-400 font-semibold"> 600+ DSA problems</span> across platforms like LeetCode, 
